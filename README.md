...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/beautifultable-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12515&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/beautifultable-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `beautifultable` can be installed with:

```
conda install beautifultable
```

It is possible to list all of the versions of `beautifultable` available on your platform with:
